...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab2_Layout.setObjectName("tab1_Layout")

        self.up_frame_2 = QtWidgets.QFrame(self.tab2)
        self.up_frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.up_frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.up_frame_2.setObjectName("up_frame")

        self.up_frame_2_Layout = QtWidgets.QVBoxLayout(self.up_frame_2)
        self.up_frame_2_Layout.setContentsMargins(-1, 0, -1, 0)
        self.up_frame_2_Layout.setObjectName("up_frame_Layout")
        ...
        self.timer_frame_2.setObjectName("timer_frame")

        self.timer_frame_2_Layout = QtWidgets.QVBoxLayout(self.timer_frame_2)
        self.timer_frame_2_Layout.setObjectName("timer_frame_Layout")
        ...
        self.timer_2.setStyleSheet(f"color: rgb({MainWindow.TEXT_COLOR});")
        self.timer_2.setAlignment(QtCore.Qt.AlignCenter)
        self.timer_2.setObjectName("timer")

        self.timer_frame_2_Layout.addWidget(self.timer_2)
        self.up_frame_2_Layout.addWidget(self.timer_frame_2, 0, QtCore.Qt.AlignTop)
        ...
        self.button_frame_2.setObjectName("button_frame")

        self.button_frame_2_Layout = QtWidgets.QHBoxLayout(self.button_frame_2)
        self.button_frame_2_Layout.setContentsMargins(0, -1, 0, -1)
        self.button_frame_2_Layout.setObjectName("button_frame_Layout")
        ...
        self.close_button_2.setObjectName("close_button")
        self.button_frame_2_Layout.addWidget(self.close_button_2)

        self.minimize_2_button = NotDraggableButton(self.button_frame_2)
        self.minimize_2_button.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Icons/minimize-sign.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.minimize_2_button.setIcon(icon1)
        self.minimize_2_button.setObjectName("minimize_button")
        self.button_frame_2_Layout.addWidget(self.minimize_2_button)

        self.pause_button_2 = NotDraggableButton(self.button_frame_2)
        self.pause_button_2.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Icons/play-button-arrowhead.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pause_button_2.setIcon(icon2)
        self.pause_button_2.setObjectName("pause_button")
        self.button_frame_2_Layout.addWidget(self.pause_button_2)

        self.flag_button_2 = FlagButton(self.button_frame_2)
        self.flag_button_2.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Icons/pennant.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.flag_button_2.setIcon(icon3)
        self.flag_button_2.setObjectName("flag_button")
        self.button_frame_2_Layout.addWidget(self.flag_button_2)
        ...
        self.restart_button_2.setObjectName("restart_button")
        self.button_frame_2_Layout.addWidget(self.restart_button_2)

        self.up_frame_2_Layout.addWidget(self.button_frame_2, 0, QtCore.Qt.AlignBottom)
        self.tab2_Layout.addWidget(self.up_frame_2)

        self.bot_frame_2 = QtWidgets.QFrame(self.tab2)
        self.bot_frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.bot_frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.bot_frame_2.setObjectName("bot_frame")

        self.bot_frame_2_Layout = QtWidgets.QVBoxLayout(self.bot_frame_2)
        self.bot_frame_2_Layout.setContentsMargins(-1, 0, -1, 0)
        self.bot_frame_2_Layout.setObjectName("bot_frame_Layout")

        # self.title_frame_2 = QtWidgets.QFrame(self.bot_frame_2)
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        ...
        # self.title_frame_2.setObjectName("title_frame")
        #
        # self.title_frame_2_Layout = QtWidgets.QHBoxLayout(self.title_frame_2)
        # self.title_frame_2_Layout.setContentsMargins(-1, 0, 9, 0)
        # self.title_frame_2_Layout.setObjectName("title_frame_Layout")
        # spacerItem = QtWidgets.QSpacerItem(14, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        # self.title_frame_2_Layout.addItem(spacerItem)
        #
        # self.time_label_2 = QtWidgets.QLabel(self.title_frame_2)
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.time_label_2.sizePolicy().hasHeightForWidth())
        # self.time_label_2.setSizePolicy(sizePolicy)
        # font = QtGui.QFont()
        # font.setPointSize(14)
        # self.time_label_2.setFont(font)
        # self.time_label_2.setStyleSheet(f"color: rgb({MainWindow.TEXT_COLOR});")
        # self.time_label_2.setAlignment(QtCore.Qt.AlignCenter)
        # self.time_label_2.setObjectName("time_label")
        # self.title_frame_2_Layout.addWidget(self.time_label_2)
        #
        # self.all_label_2 = QtWidgets.QLabel(self.title_frame_2)
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.all_label_2.sizePolicy().hasHeightForWidth())
        # self.all_label_2.setSizePolicy(sizePolicy)
        # font = QtGui.QFont()
        # font.setPointSize(14)
        # self.all_label_2.setFont(font)
        # self.all_label_2.setStyleSheet(f"color: rgb({MainWindow.TEXT_COLOR});")
        # self.all_label_2.setAlignment(QtCore.Qt.AlignCenter)
        # self.all_label_2.setObjectName("all_label")
        #
        # self.title_frame_2_Layout.addWidget(self.all_label_2)
        # spacerItem1 = QtWidgets.QSpacerItem(30, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        # self.title_frame_2_Layout.addItem(spacerItem1)
        # self.bot_frame_2_Layout.addWidget(self.title_frame_2)
        #
        # self.scroll_frame_2 = QtWidgets.QFrame(self.bot_frame_2)
        # sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        # sizePolicy.setHorizontalStretch(0)
        # sizePolicy.setVerticalStretch(0)
        # sizePolicy.setHeightForWidth(self.scroll_frame_2.sizePolicy().hasHeightForWidth())
        # self.scroll_frame_2.setSizePolicy(sizePolicy)
        # self.scroll_frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        # self.scroll_frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        # self.scroll_frame_2.setObjectName("scroll_frame")
        #
        # self.scroll_frame_2_Layout = QtWidgets.QVBoxLayout(self.scroll_frame_2)
        # self.scroll_frame_2_Layout.setContentsMargins(-1, 0, -1, 0)
        # self.scroll_frame_2_Layout.setObjectName("scroll_frame_Layout")
        #
        # self.scrollArea_2 = QtWidgets.QScrollArea(self.scroll_frame_2)
        ...
        # self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 265, 157))
        # self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents")
        # self.scrollAreaWidget_2_Layout = QtWidgets.QHBoxLayout(self.scrollAreaWidgetContents_2)
        # self.scrollAreaWidget_2_Layout.setObjectName("scrollAreaWidget_Layout")
        #
        # self.scroll_frame_2 = QtWidgets.QFrame(self.scrollAreaWidgetContents_2)
        # self.scroll_frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        # self.scroll_frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        # self.scroll_frame_2.setObjectName("scroll_frame_2")
        #
        # self.scrollArea_2_Layout = QtWidgets.QHBoxLayout(self.scroll_frame_2)
        # self.scrollArea_2_Layout.setObjectName("scrollArea_Layout")
        #
        # self.time_2_Layout = QtWidgets.QVBoxLayout()
        # self.time_2_Layout.setObjectName("time_Layout")
        # self.scrollArea_2_Layout.addLayout(self.time_2_Layout)
        #
        # self.all_2_Layout = QtWidgets.QVBoxLayout()
        # self.all_2_Layout.setObjectName("all_Layout")
        # self.scrollArea_2_Layout.addLayout(self.all_2_Layout)
        #
        # self.scrollAreaWidget_2_Layout.addWidget(self.scroll_frame_2)
        # self.scrollArea_2.setWidget(self.scrollAreaWidgetContents_2)
        #
        # self.scroll_frame_2_Layout.addWidget(self.scrollArea_2)
        # self.bot_frame_2_Layout.addWidget(self.scroll_frame_2)
        self.tab2_Layout.addWidget(self.bot_frame_2)
        self.central_Layout.addWidget(self.tab2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        # self.time_label_2.setText(_translate("MainWindow", "Время"))
        # self.all_label_2.setText(_translate("MainWindow", "Итого"))
